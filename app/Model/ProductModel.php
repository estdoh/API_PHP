...
class ProductsModel {
    ...
    public function __construct() {        
        ...
        $this->db = new mysqli_connect('mysql:host=us-cdbr-east-05.cleardb.net;','Username=be3093d987bbca','Password=14377f76','dbname=heroku_3768f01bf6856fc;charset=utf8');
