...
class ProductsModel {
    ...
    public function __construct() {        
        ...
        $this->db = new PDO('mysql:host=us-cdbr-east-05.cleardb.net;','username=be3093d987bbca','password=14377f76','db=heroku_3768f01bf6856fc', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES \'UTF8\''));
